...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3),
	    ...
	    TopicHeader = __webpack_require__(177),
	    TopicBody = __webpack_require__(178);
	...
	var Topic = React.createClass({
		...
		componentDidMount: function componentDidMount() {
			...
			$.ajax({
				url: 'http://10.161.152.254:3000/getTopic',
				type: 'GET',
				dataType: 'jsonp',
				data: {
					id: topicId
		...
		render: function render() {
			return React.createElement(
				'div',
				null,
				React.createElement(TopicHeader, null),
				React.createElement(TopicBody, null)
			);
		}
	});

	ReactDom.render(React.createElement(Topic, null), document.getElementById('topic_container'));
	...
	var TopicHeader = React.createClass({
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement('h2', { className: 'topic_header' }),
				React.createElement(
					'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TopicBody = React.createClass({
		...
		render: function render() {
			return React.createElement('div', { className: 'topic_body' });
		}
	});
